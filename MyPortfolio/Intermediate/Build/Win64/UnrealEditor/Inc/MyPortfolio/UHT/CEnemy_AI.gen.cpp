...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACEnemy_AI_Statics::NewProp_PatrolPath_MetaData[] = {
		{ "Category", "AI" },
#if !UE_BUILD_SHIPPING
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACEnemy_AI_Statics::NewProp_PatrolPath = { "PatrolPath", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACEnemy_AI, PatrolPath), Z_Construct_UClass_ACPatrolPath_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACEnemy_AI_Statics::NewProp_PatrolPath_MetaData), Z_Construct_UClass_ACEnemy_AI_Statics::NewProp_PatrolPath_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ACEnemy_AI_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACEnemy_AI_Statics::NewProp_PatrolPath,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyPortfolio_Source_MyPortfolio_Characters_CEnemy_AI_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACEnemy_AI, ACEnemy_AI::StaticClass, TEXT("ACEnemy_AI"), &Z_Registration_Info_UClass_ACEnemy_AI, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACEnemy_AI), 4173004436U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyPortfolio_Source_MyPortfolio_Characters_CEnemy_AI_h_331051863(TEXT("/Script/MyPortfolio"),
