...
void EmptyLinkFunctionForGeneratedCodeMyPortfolio_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_MyPortfolio()
	{
		if (!Z_Registration_Info_UPackage__Script_MyPortfolio.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_MyPortfolio_AIStateTypeChanged__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_MyPortfolio_ProjectileHit__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_MyPortfolio(Z_Construct_UPackage__Script_MyPortfolio, TEXT("/Script/MyPortfolio"), Z_Registration_Info_UPackage__Script_MyPortfolio, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xF6011ABF, 0x07C7B367));
